...
participant p2 as Vårdinformationssystem
c->>p: getInfo
p-->>c: info
note over c: Example of reference <br>{ 'url' : 'http://vis.region.se/filer/a.pdf' ,<br>'token' : 'eyJhbGciOiJIUzI1NiIsInR5...',<br>'Content-Type' : 'application/pdf'  }
c->>p2: fetch attachment from vis.region.se
